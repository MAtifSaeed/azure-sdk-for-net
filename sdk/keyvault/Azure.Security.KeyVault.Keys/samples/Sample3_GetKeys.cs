...
namespace Azure.Security.KeyVault.Keys.Samples
{
    ...
    public partial class GetKeys
    {
        ...
        public void GetKeysSync()
        {
            ...
            IEnumerable<KeyProperties> keys = client.ListKeys();
            ...
            IEnumerable<KeyProperties> keysVersions = client.ListKeyVersions(rsaKeyName);
            ...
            IEnumerable<DeletedKey> keysDeleted = client.ListDeletedKeys();
